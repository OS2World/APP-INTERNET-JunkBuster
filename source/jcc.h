...
extern char *blockimgfile; /* TINYGIF (Kiewitz) */
...
struct client_state {
	...
	struct file_list *ilist; /* TINYGIF (Kiewitz) */
...
extern int load_blockfile(), load_blockimgfile(), load_cookiefile(), load_trustfile(), load_forwardfile(), load_aclfile();
/* load_blockimgfile() -> TINYGIF (Kiewitz) */
...
extern char *block_imageurl(); /* TINYGIF (Kiewitz) */
